...
func (c *feedServiceClient) GetUserFeed(ctx context.Context, in *GetUserFeedReq, opts ...grpc.CallOption) (*GetUserFeedResp, error) {
...
func (UnimplementedFeedServiceServer) GetUserFeed(context.Context, *GetUserFeedReq) (*GetUserFeedResp, error) {
...
func _FeedService_GetUserFeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeedServiceServer).GetUserFeed(ctx, req.(*GetUserFeedReq))
	}
